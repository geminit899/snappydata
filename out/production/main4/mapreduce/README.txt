...
============================
   ...
   2. Copy gemfirexd.jar to maven_dist/gemfirexd-1.6.2.jar

        cp /usr/lib/gphd/gfxd/lib/gemfirexd.jar \
        /usr/lib/gphd/gfxd/examples/mapreduce/maven_dist/gemfirexd-1.6.2.jar
   
   3. Install the gemfirexd.jar into local Maven repository
   
        mvn install:install-file \
        -Dfile=maven_dist/gemfirexd-1.6.2.jar \
        -DpomFile=maven_dist/gemfirexd-1.6.2.pom
